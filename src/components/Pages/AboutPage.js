...
export const AboutPage = () => (
   <div className='AboutPage'>
      <div className='AboutPage__content m-5'>
         ...
         <div class="row align-items-md-stretch mb-4">
            ...
            <div class="col-md-6">
               <div class="h-100 p-5 bg-light border rounded-3">
                  ...
                  <p>Знать все не возможно и не нужно.Но я хочу овладеть в ближайшее время full stack разработкой и такими вещами как TypeScript и Node + библиотеки и в дальнейшем я думаю попробовать себе еще в других фреймворках</p>
               </div>
            </div>
         </div>
      </div>
